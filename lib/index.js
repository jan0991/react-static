...
function getRouteProps(Comp, customFunc) {
  var _class, _temp2;
  ...
  return (0, _reactRouterDom.withRouter)((_temp2 = _class = function (_Component) {
    ...
    function GetRouteProps() {
      ...
      return _ret = (_temp = (_this2 = _possibleConstructorReturn(this, (_ref8 = GetRouteProps.__proto__ || Object.getPrototypeOf(GetRouteProps)).call.apply(_ref8, [this].concat(args))), _this2), _this2.state = {
        ...
        var _ref9 = _asyncToGenerator( /*#__PURE__*/_regenerator2.default.mark(function _callee6(retry) {
          var path, triedOnce, _this2$props$location, pathname, search;
              ...
              switch (_context6.prev = _context6.next) {
                case 0:
                  ...
                  if (typeof retry === 'boolean') {
                    ...
                    path = customFunc ? customFunc(_this2.props.location) : (0, _shared.pathJoin)('' + pathname + search);
                  }
    ...
    _createClass(GetRouteProps, [{
      ...
      value: function render() {
        ...
        if (this.state.retry) {
          ...
          path = customFunc ? customFunc(this.props.location) : (0, _shared.pathJoin)('' + pathname + search);
        }
        ...
        return _react2.default.createElement(Comp, _extends({}, this.props, initialProps, { original: !this.state.retry }));
      }
    }]);
